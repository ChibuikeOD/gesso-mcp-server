...
## Gesso MCP Plugin
## Connects to the gesso-mcp-server via WebSocket and executes tools.
...
const MCP_RUNTIME_AUTOLOAD_PATH := "res://addons/godot_mcp/runtime/gesso_runtime.gd"
...
func _enter_tree() -> void:
	print("[Gesso MCP] Plugin loading...")
	...
	print("[Gesso MCP] Plugin loaded - connecting to MCP server...")
