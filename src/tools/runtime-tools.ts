/**
 * Runtime gameplay automation and testing tools for Gesso MCP Server.
 * Autogenerated from godot-mcp schemas.
 */
...
export const runtimeTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    "description": "Run a scripted sequence of input steps in the running game (for automated playtesting). Step types: wait, click, key_press, key_hold, key_release, mouse_move, scroll, mouse_drag, send_input (raw event object). Each step may include wait_ms before it runs. Use with take_screenshot / query_runtime_node to verify results.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "steps": {
          "type": "array",
          "description": "Ordered list of step objects, each with a \"type\" field.",
          "items": {
            "type": "object"
          }
        },
        "stopOnError": {
          "type": "boolean",
          "description": "Stop the sequence on the first failed step (default: true)."
        }
      },
      "required": [
        "steps"
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "finalValue": {
          "description": "Target value. Use {x,y} for Vector2, {x,y,z} for Vector3, {r,g,b,a} for Color"
        },
        "duration": {
          "type": "number",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "value": {
          "description": "Value to set (number, object, array, etc.)"
        },
        "typeHint": {
          "type": "string",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "angularVelocity": {
          "description": "Angular velocity (float for 2D, {x,y,z} for 3D)"
        },
        "linearDamp": {
          "type": "number",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "motionScale": {
          "type": "object",
          "description": "Motion scale {x,y}"
        },
        "motionOffset": {
          "type": "object",
          "description": "Motion offset {x,y}"
        },
        "mirroring": {
          "type": "object",
          "description": "Mirroring {x,y}"
        },
        "name": {
          "type": "string",
          "description": "Node name"
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "properties": {
          "type": "object",
          "description": "Effect properties to set"
        }
      },
      "required": [
        "action"
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "action": {
          "type": "string",
          "description": "Action: add, remove, move, set_send, list"
        },
        "busName": {
          "type": "string",
